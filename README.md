...
<body>
    ...
    <script>
        ...
        function generateNote() {
            ...
            // Build Yes/No questions section
            const yesNoSection = `Device Connectivity Issues: ${yesNoData.devicesDisconnecting === null ? '' : yesNoData.devicesDisconnecting ? 'Yes' : 'No'}
